...
CREATE  TABLE IF NOT EXISTS `RESOURCES` (
  ...
  INDEX `fk_ResourceToLanguage_idx_idx` (`LANGUAGE_ID` ASC) ,
  INDEX `fk_ResourceToLearningResource_idx_idx` (`LEARNING_RESOURCE_ID` ASC) ,
  CONSTRAINT `fk_ResourceToInteractivity_idx`
    FOREIGN KEY (`INTERACTIVITY_ID` )
    REFERENCES `INTERACTIVITY` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ResourceToLanguage_idx`
    FOREIGN KEY (`LANGUAGE_ID` )
    REFERENCES `LANGUAGES` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ResourceToLearningResource_idx`
...
-- -----------------------------------------------------
-- Table `ALIGNMENT_TYPES`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `ALIGNMENT_TYPES` (
  `ID` INT NOT NULL AUTO_INCREMENT ,
...
CREATE  TABLE IF NOT EXISTS `ALIGNMENTS` (
  ...
  `ALIGNMENT_TYPE_ID` INT NULL ,
  PRIMARY KEY (`ID`) ,
  INDEX `fk_Alignments_Standard_idx` (`RESOURCE_ID` ASC) ,
  INDEX `fk_Alignments_Standard_idx_idx` (`STANDARD_ID` ASC) ,
  INDEX `fk_Alignments_AlignmentType_idx_idx` (`ALIGNMENT_TYPE_ID` ASC) ,
  CONSTRAINT `fk_Alignments_Resource_idx`
    FOREIGN KEY (`RESOURCE_ID` )
    REFERENCES `RESOURCES` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Alignments_Standard_idx`
    FOREIGN KEY (`STANDARD_ID` )
    REFERENCES `STANDARDS` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Alignments_AlignmentType_idx`
    FOREIGN KEY (`ALIGNMENT_TYPE_ID` )
    REFERENCES `ALIGNMENT_TYPES` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
